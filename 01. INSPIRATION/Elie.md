...
There is an angle of trace or reminder of the evolution I want to explore through the thomassons, The way an useless urban structure can tell a story (maybe the first part of the thesis would be to dig into thomassons, white elephants etc.). I also want to explore "objects" that are defunct TODAY and in a first part try to classify them into thomassons, white elephants or merely memorials raised (or rather kept) in the name of nostalgia. In a second part I want to explore they porbable adaptability and reuse. Then I want to understand how different is today's street furniture and why it's prupose changed as well (from comfort to surveillance). All those elements will help me answer my question : How those objetcs tell a story and influence our perception and experience of a place.
